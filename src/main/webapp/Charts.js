/**
 * Created by Viktor Gamov on 8/26/13.
 * Demo from Sencha http://docs.sencha.com/extjs/4.2.1/extjs-build/examples/charts/Charts.html
 */
...
Ext.onReady(function () {
    ...
    var servletUrl = "http://" + document.location.host + document.location.pathname + "asyncSvg";
    Ext.override(Ext.draw.engine.ImageExporter, {
        //defaultUrl: 'http://localhost:8080/svg4sencha/svg'
        defaultUrl: servletUrl
    });

    var downloadChart = function (chart, type) {
        ...
        tbar: [
            {
                ...
                handler: function () {
                    downloadChart(chart1, 'image/jpeg');
                }
            },
            {
                text: 'Save Chart as png',
                handler: function () {
                    downloadChart(chart1, 'image/png');
                }
            }
        ],
        items: chart1
        ...
        tbar: [
            {
                text: 'Save Chart as jpeg',
                handler: function () {
                    downloadChart(chart2, 'image/jpeg');
                }
            },
            {
                text: 'Save Chart as png',
                handler: function () {
                    downloadChart(chart2, 'image/png');
                }
            }
        ],
        items: chart2
        ...
        tbar: [
            {
                text: 'Save Chart as jpeg',
                handler: function () {
                    downloadChart(chart3, 'image/jpeg');
                }
            },
            {
                text: 'Save Chart as png',
                handler: function () {
                    downloadChart(chart3, 'image/png');
                }
            }
        ],
        items: chart3
